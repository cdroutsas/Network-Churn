...
for counter=1:M
    N = 750;
    A = pref(N,4); %sf sto SF d=4 exasfalizetai an valeis d=2 stin etoimi synartisi
        % erdrey_mit(N,[],E); %rg
        % pref(100,6); %sf
    ...
    Average_node_degree_old(1,counter)= mean(degrees(A));
...
ones = 0;
    ...
    Average_node_degree_new(1,counter)= mean(degrees(A));
