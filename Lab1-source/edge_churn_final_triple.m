...
for counter=1:M
    A = pref(N,d); %sf sto SF d=4 exasfalizetai an valeis d=2 stin etoimi synartisi
        %erdrey_mit(N,[],E); %rg
        % pref(100,6); %sf
    ...
    Average_node_degree_old(1,counter,metritis)= tmp_node_degrees(1);
   ...
   % disp(datestr(now));
    ...
    tmp_node_degrees = degrees(A);
    Average_node_degree_new(1,counter,metritis)= tmp_node_degrees(1);
